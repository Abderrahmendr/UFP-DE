...
<div className='flex justify-center items-center mt-16 mb-10 '>
    <a href="#" className="group relative block overflow-hidden ">
      ...
      <div className="relative border border-gray-100 shadow-xl shadow-teal-800  p-6">
        ...
        <h3 className="mt-4 text-lg font-medium text-gray-900">NACON GAMING TASTATUR </h3>
    
        <p className="mt-1.5 text-sm text-gray-700"> GAMING TASTATUR <br/> Kabel, USB <br/> RGB <br/> </p>
