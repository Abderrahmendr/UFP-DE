...
function Header() {
 ...
 {/* <div className="relative lg:left-10 sm:right-24 sm:gap-4 sm:p-8 xl:flex  sm:flex sm:size-0.5 md:top-8 md:gap-4  md:flex md:center md:right-0">
    <div className="absolute  right-6  ">
      <Search  />
    </div>

    <a
      className="relative -mr-16  xs:hidden lg:flex md:flex hover:animate-bounce rounded-full h-8 bg-gray-300 md:right-24 p-2 text-black shadow hover:bg-teal-600 hover:text-white xs:mb-4 xs:mr-0"
      href="#"
    >
      <FaShoppingCart />
    </a>

    <div className="relative  xs:-right-3 xs:flex  -top-6 right-8 ">
      <Log className="bg-gray-100 text-black no-underline  text-sm font-medium" />
  </div> 
  </div>
*
  <div className="block lg:hidden absolute -top-2 sm:right-1 md:left-1 p-10  xs:-right-3 ">
    <button className="rounded bg-gray-100 p-2 text-gray-600 transition hover:text-sky-950"   >
      <svg
