...
function storage_media() {
  return (
	<div className="bg-white w-full     m-8 overflow-hidden  " >
    <h1 className='absolute   top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pb-14  font-extrabold text-3xl underline-[#04cecf]   border-b-2  border-[#04cecf]  '>Storage  Produkts</h1>
