...
function office() {
  return (
	<div className="bg-white w-full     m-8 overflow-hidden  " >
        <h1 className='absolute   top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pb-14  font-extrabold text-3xl underline-[#04cecf]   border-b-2  border-[#04cecf]  '>IT/Office Produkts</h1>
			<div class=" flex justify-center items-center  mt-80    ">
			<img 
			className="opacity-20 -mt-10"
			src="/UFP_logo.png" 
			alt="" />
			<p className="flex justify-center items-center -ml-44    text-3xl pb-16 font-extrabold
...
<div className=" -mt-28 grid ml-8 p-28 grid-cols-4 gap-16  w-full">
